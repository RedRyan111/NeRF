...
class NeRFManager(nn.Module):
    def __init__(self, encoding_function, rays_from_camera_builder, query_sampler):
        super().__init__()
    ...
    def forward(self, model, tform_cam2world, target_img, optimizer):
        ...
        encoded_points_example = encoded_points.reshape(-1, 32, 63)
        ...
        for j in range(0, encoded_points_example.shape[0], chunksize):
            ...
            cur_depth_values = depth_values.reshape(-1, 32)[j: j+chunksize]
